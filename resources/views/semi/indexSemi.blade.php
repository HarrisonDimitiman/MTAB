                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    @foreach($semi as $semi)
                                        <tr>
                                            <td>{{ $semi->id ?? '' }}</td>
                                            <td>{{ $semi->name ?? '' }}</td>
                                            <td>{{ $semi->semi_percentage ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <button type="button" class="dropdown-item btn btn-edit" data-url="{{ URL::to('/editSemi',$semi->id) }}">
                                                            <i class="cil-pencil"></i>
                                                            &nbsp;Edit
                                                        </button>
                                                       
                                                        <form action="{{ URL::to('/destroySemi',$semi->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
