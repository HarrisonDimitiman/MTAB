                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    @foreach($allJudges as $allJudges)
                                        <tr>
                                            <td>{{ $allJudges->id ?? '' }}</td>
                                            <td>{{ $allJudges->judges_name ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <button type="button" class="dropdown-item btn btn-edit" data-url="{{ route('judges.edit',$allJudges->id) }}">
                                                            <i class="cil-pencil"></i>
                                                            &nbsp;Edit
                                                        </button>
                                                        <form action="{{ route('judges.destroy',$allJudges->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
