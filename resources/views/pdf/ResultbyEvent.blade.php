...
<p style="position:absolute;left:20px;top:1000px;color: #0073e6;font-size:12px;">TESDA Provincial Office - Iligan, Maria Cristina, Iligan City, 9200</p>
<p style="position:absolute;left:20px;top:1015px;color: #0073e6;font-size:12px;">Landline/Telefax No.: (063) 221-5777</p>

<p style="position:absolute;left:20px;top:1030px;color: #0073e6;font-size:12px;">Email: region10.lanaodelnorte@tesda.gov.ph</p>
<img width="200" height="80" src="{{ public_path('assets/img/bb.jpg')}}" style="position:absolute;left:550px;top:1000px;" alt="">
<script>
    var dt = new Date();
