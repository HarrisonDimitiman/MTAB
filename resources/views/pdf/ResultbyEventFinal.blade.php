...
<p style="position:absolute;left:210px;top:95px;font-size:15px;">RESULT EVENT BB. MARIA CRISTINA FINALIST</p>
...
<div style="position:absolute;left:20px;top:150px;">
    <table style="width:100%;border-collapse: collapse;">
        ...
        @foreach($final as $i=> $topsss)
        <tr>
        <td style="font-size:12px;border: 1px solid black;border: 1px solid black;border: 1px solid black;text-align:center;height:25px;">{{strtoupper($topsss->number)}}</td>
            <td style="font-size:12px;border: 1px solid black;border: 1px solid black;border: 1px solid black;border: 1px solid black;text-align:center;height:25px;">{{strtoupper($topsss->name)}}</td>
            <td style="font-size:12px;border: 1px solid black;border: 1px solid black;border: 1px solid black;text-align:center;height:25px;">{{strtoupper($topsss->location)}}</td>
            <td style="font-size:12px;border: 1px solid black;border: 1px solid black;text-align:center;height:25px;">{{strtoupper($topsss->overAllTotalJudge)}}</td>
